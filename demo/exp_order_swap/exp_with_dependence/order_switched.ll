...
if.then:                                          ; preds = %for.body
  %arrayidx2 = getelementptr inbounds [100 x i8], ptr %arr3, i64 0, i64 0
  %2 = load i8, ptr %arrayidx2, align 16
  %conv = sitofp i8 %2 to float
  %3 = load i32, ptr %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx3 = getelementptr inbounds [100 x float], ptr %arr, i64 0, i64 %idxprom
...
if.then5:                                         ; preds = %if.end
  ...
  store i8 99, ptr %arrayidx7, align 1
