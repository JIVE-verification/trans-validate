 ...
 * Compile with "mpicc gauss_o_4.c -o gauss_o_4.out" 
 */
/* This is aprogram running Gaussian elimination via OpenMP using 4 threads.
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
/* Using OpenMP with 4 threads runing the for loop and having a private parameter 'norm' initiated with the value from parent thread  */
    dummyMethod1();
