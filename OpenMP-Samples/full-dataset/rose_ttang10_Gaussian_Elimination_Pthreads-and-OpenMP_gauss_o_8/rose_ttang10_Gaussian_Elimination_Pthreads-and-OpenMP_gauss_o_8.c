 ...
 * Compile with "mpicc gauss_o_8.c -o gauss_o_8.out" 
 */
/* This is aprogram running Gaussian elimination via OpenMP using 8 threads.
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
/* Using OpenMP with 8 threads runing the for loop and having a private parameter 'norm' initiated with the value from parent thread  */
    dummyMethod1();
